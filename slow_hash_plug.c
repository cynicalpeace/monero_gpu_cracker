...
/* Include the new header so that extra_hashes is declared for external linkage */
#include "slow_hash_extra.h"

/* Remove the static qualifier so that extra_hashes is exported.
 * (Previously it was declared as:
 *  static void (*const extra_hashes[4])(const void *, size_t, char *) = { ... };
 * )
 */
void (*extra_hashes[4])(const void *, size_t, char *) = {
